...
const MODULE_BLUEPRINTS: Record<string, string> = {
  ...
  'Finanzas y Créditos': 'Pestañas y Funciones Avanzadas: 1. Cuentas por Cobrar (CXC): Monitoreo de cartera vencida y al día, registro de abonos parciales/totales, comprobantes y recordatorios directos por WhatsApp a clientes. 2. Cuentas por Pagar (CXP): Programación de pagos a proveedores, control de vencimiento según días de crédito y registro de egresos. 3. Gestión de Quedan: Emisión y cobranza de quedan. 4. Nómina & Recursos Humanos: Cálculo automático de planilla con ley de El Salvador (ISSS 3% max $30, AFP 7.25%, Renta ISR), amortización de préstamos a colaboradores, comisiones y pago de salario neto.',
