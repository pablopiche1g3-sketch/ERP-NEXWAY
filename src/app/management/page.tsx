...
ALTER TABLE public.inventory ADD COLUMN IF NOT EXISTS name text; ALTER TABLE public.inventory ADD COLUMN IF NOT EXISTS category text; ALTER TABLE public.inventory ADD COLUMN IF NOT EXISTS price numeric(10,2) DEFAULT 0.00; ALTER TABLE public.inventory ADD COLUMN IF NOT EXISTS cost numeric(10,2) DEFAULT 0.00; ALTER TABLE public.inventory ADD COLUMN IF NOT EXISTS margin numeric(10,2) DEFAULT 0.00;
