    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#0a1120] text-white">
        <div className="flex flex-col items-center gap-4">
          <LayoutDashboard className="w-12 h-12 animate-pulse text-blue-500" />
          <p className="text-slate-400 font-medium">Cargando NexWay ERP...</p>
        </div>
      </div>
    );
  }
      ...
      <main className="flex-1 flex flex-col min-w-0">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3 pl-4 border-l border-slate-200">
              <div className="text-right hidden sm:block">
                <p className="text-sm font-bold text-slate-900">{user?.displayName || user?.email?.split('@')[0]}</p>
        ...
        <div className="p-8 space-y-8 overflow-auto">
          <div>
            ...
            <p className="text-slate-500">Bienvenido de nuevo, aquí tienes un resumen de hoy.</p>
          </div>
