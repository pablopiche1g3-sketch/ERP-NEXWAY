  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-4 sm:p-6 overflow-hidden relative transition-colors duration-300">
      ...
      <div className="absolute top-0 left-0 right-0 bottom-0 pointer-events-none z-0">
        <div className="absolute -top-[20%] -left-[10%] w-[50%] h-[50%] rounded-full bg-gradient-to-br from-blue-400/20 to-indigo-400/0 dark:from-blue-600/10 dark:to-transparent blur-[120px] animate-pulse duration-5000" />
        <div className="absolute -bottom-[20%] -right-[10%] w-[50%] h-[50%] rounded-full bg-gradient-to-tl from-indigo-400/20 to-blue-400/0 dark:from-indigo-600/10 dark:to-transparent blur-[120px] animate-pulse duration-7000" />
